...
public class RunCreateNetworkFromOSM {
    ...
    private static final Path input = Paths.get("patriki_map.osm");
    ...
    private void create() {
        ...
        CoordinateTransformation transformation = TransformationFactory.getCoordinateTransformation(
                TransformationFactory.WGS84, "EPSG:32637");
        ...
        new NetworkWriter(network).write("scenarios/patriki/network.xml.gz");
    }
